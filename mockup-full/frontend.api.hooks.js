 ...
 * src/api/hooks.js
 *
 * React Query–style hooks built on native React state.
 * Drop in React Query (TanStack Query) for caching + background refetch
 * if the project grows — the API client calls stay identical.
 */
...
export function useRaces() {
  ...
  return { races: data ?? [], loading, error, refetch, updateRace };
}


// ── Admin: weekend results entry ──────────────────────────────────────────────
